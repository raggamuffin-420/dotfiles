...
# map nickname to output of 'pactl list sinks short | cut -f2'
declare -A SINK_NICKNAMES
SINK_NICKNAMES["alsa_output.pci-0000_05_00.6.analog-stereo"]="蓼 Laptop Speakers"
SINK_NICKNAMES["bluez_sink.04_52_C7_8E_37_4E.a2dp_sink"]="蓼 Bose Mini II"
SINK_NICKNAMES["bluez_sink.00_23_10_0B_1A_44.a2dp_sink"]=" JLab Earbuds"
SINK_NICKNAMES["bluez_sink.44_18_FD_B7_6C_DD.a2dp_sink"]=" Beats Studio 3"
...
function output() {
    ...
    if [ "$isMuted" = "yes" ]; then
        ...
        echo "%{F$(xgetres baraccentfg)}${volIcon}%{F-}${curVol}%   %{F$(xgetres baraccentfg)}${SINK_ICON}${nickname}%{F-}"
    fi
}
